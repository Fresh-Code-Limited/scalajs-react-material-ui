...
trait ZIndexOptions extends js.Object {
  ...
  def speedDial: js.UndefOr[Int] = js.native
  ...
  def fab: js.UndefOr[Int] = js.native
}
...
object ZIndexOptions {
  ...
  def apply(
    ...
    speedDial: js.UndefOr[Int] = js.undefined,
    ...
    fab: js.UndefOr[Int] = js.undefined,
  ): ZIndexOptions = {
    val o: Map[String, Any] = Seq(
      mobileStepper.toOption.map("mobileStepper" -> _),
      speedDial.toOption.map("speedDial" -> _),
